/**
 ...
 #define htobe32(x) (uint32_t)(x >> 24) | (uint32_t)(x >> 8) & 0x0000FF00 | (uint32_t)(x << 8) & 0x00FF0000 | (uint32_t)(x << 24)
...
//   int sha1Compute(const void *data, size_t length, uint8_t *digest)
//  {
//     int error;
//     Sha1Context *context;
...
//  }
  ...
  void sha1Update(Sha1Context *context, const void *data, size_t length)
 {
  ...
  void sha1Update_i0(Sha1Context *context, const void *data, size_t length)
 {
    length = 72;
    size_t n;
  ...
  void sha1Update_i1(Sha1Context *context, const void *data, size_t length)
 {
    length = 84;
    size_t n;
