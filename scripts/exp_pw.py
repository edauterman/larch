...
def run_pw_exp():
    ...
    time.sleep(10)
    executeRemoteCommand(getHostName(machines['client_ip_address']), 'cd zkboo-r1cs; ./scripts/wan.sh M; ./build/bin/pw_latency_bench %s ~/pw_exp/out' % (machines['server_ip_address']), key=properties['secret_key_path']) 
